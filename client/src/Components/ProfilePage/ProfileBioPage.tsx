...
function ProfileBioPage(): JSX.Element {
    ...
    return (
      ...
      <div className={"flex flex-col"}>
        ...
        <div className={'font-extrabold text-xl col-start-1 col-end-3 flex-1'}>{user[0].fio}</div>
        <div className={'font-extrabold'}>{user[0].email}</div>
        <div className={'font-extrabold'}>{user[0].phone}</div>
      </div>
